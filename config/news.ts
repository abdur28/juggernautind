...
export const newsArticles: NewsArticle[] = [
  {
    ...
    content: `
      ...
      <p>The policy covers all sectors of our operations, including our deep-hole drilling sites in Osun and Oyo states, our agricultural processing centers in Bida, and our construction projects nationwide.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>Our investment in mechanized equipment, including tractors and specialized processing machinery, ensures that JIL remains a leader in Nigeria's agro-processing sector.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>This project builds on our track record of successful exploration, including our previous discovery of Lead, Zinc, and Silver deposits under the National Integrated Mineral Exploration Project (NIMEP).</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>As we approach our second decade of operations, the summit reaffirmed our vision: to be on the global listing of world-class companies through excellence, integrity, and innovation.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>As we look toward the future, we remain dedicated to unlocking Africa's natural resources responsibly and sustainably, ensuring that our growth contributes to the prosperity of the continent.</p>
    `,
